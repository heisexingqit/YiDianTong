...
// 展示自主学习的错题列表
public class BookAutoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "BookAutoAdapter";
    ...
    public BookAutoAdapter(Context context, List<BookExerciseEntity> itemList) {
