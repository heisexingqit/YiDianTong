...
public class OnlineTestSubmitActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "OnlineTestSubmitActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flag.equals("自主学习")) {
            btn_submit.setText("开始自主学习");
        }
        if (flag.equals("智能检测")) {
            btn_submit.setText("开始智能检测");
        }
            ...
            case R.id.btn_submit:
                ...
                for (int i = 0; i < itemList.size(); i++) {
                    if (itemList.get(i).getAccType() == 0) {
                        // 提示
                        if (flag.equals("自主学习")) {
                            Toast.makeText(this, "有试题未答，无法开始自主学习!", Toast.LENGTH_SHORT).show();
                        }
                        if (flag.equals("智能检测")) {
                            Toast.makeText(this, "有试题未答，无法开始智能检测!", Toast.LENGTH_SHORT).show();
                        }
                        flag1 = true;
                        break;
                    }
                ...
                Intent intent = null;
                if (flag.equals("自主学习")) {
                    intent = new Intent(this, KnowledgePointActivity.class);
                }
                if (flag.equals("智能检测")) {
                    intent = new Intent(this, DetectionShiTiDetailActivity.class);
                }
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 100) {
                ...
                if (f == 0) {
                    Toast.makeText(OnlineTestSubmitActivity.this, "提交失败！", Toast.LENGTH_SHORT).show();
                }
