...
public class BookExerciseDetailActivity extends AppCompatActivity implements RecyclerInterface {
    private static final String TAG = "BookExerciseDetailActivity";
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 100) {
                ...
                adapter.update2(list,1,userName,subjectId,course_name,exerciseType,currentpage,allpage);
            }
        }
    };
        ...
        StringRequest request = new StringRequest(mRequestUrl, response -> {
            try {
                ...
                for (BookExerciseEntity item : itemList) {
                    ...
                    Matcher m2 = p.matcher(answer);
                    String answerStr = m2.replaceAll("").trim();
