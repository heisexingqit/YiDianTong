...
public class TTeachEditHomeworkActivity extends AppCompatActivity implements View.OnClickListener, THomeworkAddInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fragment写入
        addFragment = new THomeworkPickAddFragment(xueduanCode, xuekeCode, banbenCode, jiaocaiCode, zhishidianId, "all", "99");
    ...
    private void loadPickList() {
        ...
        StringRequest request = new StringRequest(mRequestUrl, response -> {
            try {
                ...
                Gson gson = new Gson();
                List<THomeworkAddEntity> moreList = gson.fromJson(itemString, new com.google.gson.reflect.TypeToken<List<THomeworkAddEntity>>() {
                }.getType());
