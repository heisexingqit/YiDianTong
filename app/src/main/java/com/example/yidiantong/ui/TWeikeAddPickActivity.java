...
import com.example.yidiantong.fragment.TWeikePickAddFragment;
import com.example.yidiantong.fragment.TWeikePickAssignFragment;
import com.example.yidiantong.fragment.TWeikePickChangeFragment;
...
public class TWeikeAddPickActivity extends AppCompatActivity implements View.OnClickListener, TLearnPlanAddInterface {
    ...
    // Fragment组件
    private TWeikePickAddFragment addFragment;
    private TWeikePickChangeFragment changeFragment;
    private TWeikePickAssignFragment assignFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.type = "resource";
        shareTag = "99";
        addFragment = new TWeikePickAddFragment(xueduan, xueduanId, xueke, xuekeId, banben, banbenId, jiaocai, jiaocaiId, zhishidian, zhishidianId, this.type, typeSub, shareTag);
        changeFragment = new TWeikePickChangeFragment();
    ...
    public void submit(String startTime, String endTime, String ketang, String ketangId, String clas, String classId, String assignType, String stuIds, String stuNames, String learnType, String flag, int zouyeType, int zouyeFlag, String xiezuozuId, String xiezuozuName) {
        ...
        try {
            ...
            params.put("type", "2");
            params.put("learnPlanType", learnPlanType);
