...
public class TPackageAddPickActivity extends AppCompatActivity implements View.OnClickListener, TLearnPlanAddInterface {

    private static final String TAG = "TPackageAddPickActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tpackage_add_pick);
        ...
        this.type = "resource";
        shareTag = "99";
        addFragment = new TPackagePickAddFragment(xueduan, xueduanId, xueke, xuekeId, banben, banbenId, jiaocai, jiaocaiId, zhishidian, zhishidianId, this.type, typeSub, shareTag);
