...
public class TPackageAddActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "TPackageAddActivity";
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_confirm:
                if (StringUtils.hasEmptyString(et_name.getText().toString(), xueduan, xueke, banben, jiaocai, zhishidian, et_study_time.getText().toString(), et_search_time.getText().toString())) {
                    ...
                    Intent intent = new Intent(this, TPackageAddPickActivity.class);
