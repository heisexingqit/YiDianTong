...
public class TLiveAddActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "TLiveAddActivity";
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 100) {
                ...
                ContextThemeWrapper wrapper = new ContextThemeWrapper(TLiveAddActivity.this, R.style.CustomRadioStyle);
                // map快速访问映射
                for (int i = 0; i < subjectList.size(); ++i) {
                    ...
                    if (subjectList.size() > 1) {
                        ...
                        params.setMarginStart(PxUtils.dip2px(TLiveAddActivity.this, 10));
    ...
    private void submit() {
        ...
        mRequestUrl = Constant.API_LIVE + Constant.T_LIVE_ADD + "?userId=" + MyApplication.username + "&title=" + title + "&subjectId=" + subjectMap.get(selectedSubject) + "&subjectName=" + subject + "&startTime=" + tv_start_time.getText().toString()
                ...
                + "&type=" + type + "&ketangId=" + ketangStr + "&xzzId=" + groupId + "&xzzName=" + groupName + "&flag=save&roomId=";
