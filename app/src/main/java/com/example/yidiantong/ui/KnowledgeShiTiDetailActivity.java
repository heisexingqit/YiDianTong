...
public class KnowledgeShiTiDetailActivity extends AppCompatActivity implements RecyclerInterface {
...
//        String mRequestUrl = Constant.API + Constant.ERROR_QUE_ANSWER_QUESTION + "?sourceId=" + sourceId +"&userName=" +userName +"&subjectId="
//                + subjectId +"&currentPage=" + pos + "&questionId=" + questionId;
