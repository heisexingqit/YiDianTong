...
public class DetectionSubmitActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "DetectionSubmitActivity";
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 100) {
                ...
                if (f == 0) {
                    Toast.makeText(DetectionSubmitActivity.this, "提交失败！", Toast.LENGTH_SHORT).show();
                }
