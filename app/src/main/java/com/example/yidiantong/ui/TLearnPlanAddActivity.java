...
public class TLearnPlanAddActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "TLearnPlanAddActivity";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_toPoint:
                ...
                TLearnPlanAddActivity.MyJavaScriptInterface jsInterface = new TLearnPlanAddActivity.MyJavaScriptInterface(this);
            ...
            case R.id.btn_confirm:
                if (StringUtils.hasEmptyString(et_name.getText().toString(), xueduan, xueke, banben, jiaocai, zhishidian, et_study_time.getText().toString(), et_search_time.getText().toString())) {
                    ...
                    Intent intent = new Intent(this, TLearnPlanAddPickActivity.class);
    ...
    private void loadXueKe() {
        ...
        StringRequest request = new StringRequest(mRequestUrl, response -> {
            ...
            try {
                ...
                Log.e("wen", "学科: " + xuekeMap);
                // -----------------//
                // 判断同步学科 第4步
                // -----------------//
                if (loadPreference) {
                    String xuekeName = preferences.getString("xueke", "");
                    Log.e(TAG, "loadXueKe: " + xuekeName);
