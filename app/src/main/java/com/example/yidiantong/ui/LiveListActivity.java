...
import com.example.yidiantong.adapter.LiveRecyclerAdapter;
...
public class LiveListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new LiveRecyclerAdapter(this, new ArrayList<>());

        // 设置item点击事件
        adapter.setmItemClickListener(new LiveRecyclerAdapter.MyItemClickListener() {
            public void onItemClick(int pos) {

                // 设置Dialog
                dialog = new LiveEnterDialog(LiveListActivity.this);
                // 设置Title
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what == 100) {
                ...
                List<LiveItemEntity> moreList = (List<LiveItemEntity>) message.obj;
                // 无论什么情况，都是打开进度条遮蔽的
    ...
    private void loadItems_Net() {
        ...
        mRequestUrl = Constant.API + Constant.LIVE_ITEM +
                "?currentPage=" + currentPage + "&userId=" + MyApplication.username + "&type=" + type + "&searchStr=" + searchStr;
        ...
        StringRequest request = new StringRequest(mRequestUrl, response -> {
            ...
            try {
                ...
                List<LiveItemEntity> moreList = gson.fromJson(itemString, new TypeToken<List<LiveItemEntity>>() {
                }.getType());
                ...
                // 发送消息给主线程
                if (moreList.size() < 30 && moreList.size() > 0) {
                    adapter.isDown = 1;
                }
