...
public class LearnPlanReadingFragment extends Fragment implements View.OnClickListener {
    ...
    public static LearnPlanReadingFragment newInstance(LearnPlanItemEntity learnPlanEntity, int position, int size, StuAnswerEntity stuAnswerEntity) {
        LearnPlanReadingFragment fragment = new LearnPlanReadingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        choiceLen = Integer.parseInt(learnPlanEntity.getQuestionChoiceList());
