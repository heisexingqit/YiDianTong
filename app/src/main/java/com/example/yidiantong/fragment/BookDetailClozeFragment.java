...
public class BookDetailClozeFragment extends Fragment implements View.OnClickListener {
    ...
    public static BookDetailClozeFragment newInstance(BookRecyclerEntity bookrecyclerEntity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //获取view
        View view = inflater.inflate(R.layout.fragment_book_detail_cloze, container, false);
...
//                builder_exercise.show();
    ...
    private void mode_stuans() {
        if (bookrecyclerEntity.getStuAnswer().length() == 0) {
            ...
            tv_stu_answer.setText(bookrecyclerEntity.getStuAnswer());
