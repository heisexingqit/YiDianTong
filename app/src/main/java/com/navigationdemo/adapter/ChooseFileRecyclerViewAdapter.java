...
public class ChooseFileRecyclerViewAdapter extends RecyclerView.Adapter<MyViewHoder>{
    ...
    private OnSwitchFileClickListener mOnSwitchFileClickListener;
    ...
    public void setOnSwitchFileClickListener(OnSwitchFileClickListener mOnSwitchFileClickListener) {
