...
public class BoardLoadingAirRescourseAdapter extends BaseAdapter {
    ...
    private OnChooseFileClickListener mOnChooseFileClickListener;
    ...
    public void setOnSpeakerControllerClickListener(OnChooseFileClickListener mOnChooseFileClickListener) {
