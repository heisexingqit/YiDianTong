...
#include <jni.h>
/* Header for class com_example_yidiantong_util_LameUtil */

#ifndef _Included_com_example_yidiantong_util_LameUtil
#define _Included_com_example_yidiantong_util_LameUtil
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_example_yidiantong_util_LameUtil
 * Method:    init
 * Signature: (IIIII)V
 */
